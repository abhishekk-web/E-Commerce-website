...
var addToCartButtons = document.getElementsByClassName('btn-cart')
    ...
    document.getElementsByClassName('see-the-cart-btn')[0].addEventListener('click', purchaseClicked)
}
...
function ready() {
    ...
    var addToCartButtons = document.getElementsByClassName('button-links')
    for (var i = 0; i < addToCartButtons.length; i++) {
        var button = addToCartButtons[i]
        button.addEventListener('click', addToCartClicked)
    }
